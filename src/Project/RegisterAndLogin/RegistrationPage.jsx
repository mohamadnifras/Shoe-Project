...
function RegistrationPage() {
 const {userRegister, addRegister}=useContext(passContext);
  ...
  const handleSubmit= async(values)=>{
    ...
    const saveValue={
      ...
      if(existUserRegister.lenght > 0 ){
        console.log(existUserRegister.data);
        alert('All Ready registered')
        
      }else

      {
        const AddRegister= await addRegister(saveValue)
        console.log('User registered successfully:',AddRegister.data);
        navigate('/login');
      }
